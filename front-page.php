...
/**
* This is the front page of this template
*
* @link
*
* @package tierone
...
get_header();
?>
<div class="tier-front-page">
	<?php if ( "page" == get_option( 'show_on_front' ) ) { ?>
		<div class="container">
			<div id="primary" class="content-area tier-site-white clearfix">
				<?php if( is_active_sidebar( 'tier-module-section' ) ) : ?>
					<?php dynamic_sidebar( 'tier-module-section' ); ?>
				<?php endif; ?>
				<div class="col-md-8">
					<main id="main" class="tier-site-main" role="main" itemscope itemtype="http://schema.org/Blog">
						<?php
							if ( is_active_sidebar( 'tier-front-section' ) ) {
								dynamic_sidebar( 'tier-front-section' );
							}else{
